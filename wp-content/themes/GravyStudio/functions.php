...
add_action('wp_ajax_load-productions', 'ajax_productions_news');
...
function load_productions($year, $month){
...
function ajax_load_productions($year, $month){
	$month = $_POST['month'];
	$year = $_POST['year'];
    load_productions($year, $month);
}
