                            ...
                            <div class="shell">
                                <div class="holder">
									...
									<?php if ( get_sub_field( 'link_text' ) != null ) { ?>
                                        <a class="read-more" target="<?php the_sub_field( 'open_in' ); ?>"
                            ...
                            <a href="<?= get_permalink( $album->ID ); ?>" class="item">
                                <div class="holder">
                                    ...
                                    <div class="text">
	                                    ...
	                                    <?php
                                            $artists       = get_field( 'assigned_artist', $album->ID );
                                            $artists_names = array();
                    ...
                    <div class="holder">
                        <div class="section-header">
							...
							<?php if ( get_sub_field( 'col_right_link_text' ) != null ) { ?>
                                <a class="cta"
                                   href="<?= get_sub_field( 'col_right_link_url' ); ?>"><?= get_sub_field( 'col_right_link_text' ); ?></a>
							<?php } ?>
                        </div>
                        <div class="items">
							<?php
                    ...
                    <div class="holder">
                        <div class="section-header">
							...
							<?php if ( get_sub_field( 'col_left_link_text' ) != null ) { ?>
                                <a class="cta"
                                   href="<?= get_sub_field( 'col_left_link_url' ); ?>"><?= get_sub_field( 'col_left_link_text' ); ?></a>
							<?php } ?>
                        </div>
                        <div class="items">
							<?php
